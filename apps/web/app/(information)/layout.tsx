...
.infobar { position: sticky; top: 0; z-index: 40; display: flex; align-items: center;
  gap: 18px; flex-wrap: wrap; padding: 10px 12px;
...
.infobar__nav { display: flex; align-items: center; gap: 4px; flex-wrap: wrap;
  margin-inline: auto; }
.infobar__link { padding: 7px 7px; font-size: 13px; font-weight: 600;
...
.info { width: 100%; max-width: 940px; margin-inline: auto; padding: 18px 12px 56px;
...
.info__section { scroll-margin-top: 76px; margin-bottom: 18px; padding: 13px;
...
.info__note { display: flex; gap: 10px; margin: 0 0 18px; padding: 8px 10px;
...
.info__cta { display: inline-flex; align-items: center; justify-content: center;
  padding: 9px 10px; font: inherit; font-size: 13px; font-weight: 800;
