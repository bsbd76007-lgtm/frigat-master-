...
/**
 * Metadata shell for /games/crash.
 *
...
export const metadata: Metadata = {
  title: 'Crash',
  description:
    'Watch the multiplier climb and cash out before the curve breaks. Provably fair: the outcome is committed to a published seed hash before the round starts, so it can be verified afterwards.',
  alternates: { canonical: '/games/crash' },
};
