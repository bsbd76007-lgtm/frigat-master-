...
.fg-hist__badge--button { cursor: pointer; transition: transform var(--fg-t), filter var(--fg-t); }
.fg-hist__badge--button:hover { transform: translateY(-1px); filter: brightness(1.15); }
.fg-hist__badge--button:focus-visible { outline: none; box-shadow: var(--fg-ring); }
